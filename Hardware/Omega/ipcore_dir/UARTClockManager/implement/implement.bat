...
xst -ifn xst.scr
move UARTClockManager_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\UARTClockManager_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc UARTClockManager_exdes.ucf UARTClockManager_exdes

echo 'Running map'
map -timing -pr b UARTClockManager_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm UARTClockManager_exdes -w routed.ncd routed.vhd
cd ..
